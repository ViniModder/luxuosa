...
----------------------------------------------------------------------------------------------------------------------
-- Créditos: https://wiki.altv.mp/wiki/Snippet:Cayo_Perico_Island
----------------------------------------------------------------------------------------------------------------------
-- Requer:
-- Artefatos atualizados: https://runtime.fivem.net/artifacts/fivem/build_server_windows/master/
-- Forçar b2189: "server.cfg/set sv_enforceGameBuild 2189" ou "server.cmd/+set sv_enforceGameBuild 2189" (sem "aspas")
-- Adicionar o código abaixo em qualquer client.lua ou "vrp\client\iplloader.lua"
----------------------------------------------------------------------------------------------------------------------
