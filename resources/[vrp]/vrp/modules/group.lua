...
-- SPAWN
-----------------------------------------------------------------------------------------------------------------------------------------
-- function UpdateUserGroups(user_id)
...
-- function OnPlayerSpawn(user_id, source, first_spawn)
--     if first_spawn then
--         UpdateUserGroups(user_id) -- Atualiza os grupos do usuário quando o jogador ressurgir pela primeira vez
--         SetInterval(1000, function() -- Define o intervalo de atualização para 1000 milissegundos (1 segundo)
--             UpdateUserGroups(user_id) -- Atualiza os grupos do usuário periodicamente
--         end)
--     end
-- end

-- -- Função para definir um intervalo de tempo (em milissegundos)
-- function SetInterval(ms, callback)
--     local interval = Citizen.SetTimeout(ms, function()
--         callback()
--         SetInterval(ms, callback) -- Chama recursivamente a função após o intervalo
--     end)
--     return interval
-- end

-- AddEventHandler("vRP:playerSpawn", OnPlayerSpawn)
