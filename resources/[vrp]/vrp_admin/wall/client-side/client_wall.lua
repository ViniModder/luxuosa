pedrin = module("vrp","lib/Tunnel").getInterface(GlobalState["hazzardsv"])
...
RegisterNetEvent(GlobalState["hazzard_wall"]..":wall")
AddEventHandler(GlobalState["hazzard_wall"]..":wall",function(val)
    wall = val
